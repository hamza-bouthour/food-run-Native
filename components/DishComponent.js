...
import { Text, View, ScrollView, StyleSheet, Alert, Image, TouchableWithoutFeedback  } from 'react-native';
import { Card } from 'react-native-elements';
import { connect } from 'react-redux';
import { PRODUCTS } from '../shared/products';
import { markFavorite, addDishToCart, addProductToFavorite, addProductToTotal, removeProductFromCart, addProductToCart, fetchProducts } from '../redux/ActionCreators';
        ...
        return (
            <Animatable.View
                ...
                <ScrollView 
                    ...
                    <RenderDish 
                        dish={dish} 
                        favorite={this.props.populars.favorites.includes(dishPopularId)} 
                        markFavorite={() => this.markFavorite(dishPopularId)}/>
                    <RenderDishDetails  
                        dish={dish} />
                    <ScrollView
                        horizontal={true}
